    ...
    BlocBuilder<ExplorePageBloc, ExplorePageState>(
      ...
      builder: (context, state) {
            ...
            return IconButton(
              ...
              onPressed: () {
                explorePageBloc.add(ExplorePageLikeEvent(
                    saveFood: RestaurantData.restaurantModel));
              },
              icon: SavedListData.saveFood
                      .contains(RestaurantData.restaurantModel)
                  ? const Icon(
                      Icons.favorite,
                      color: AppColor.globalPink,
                    )
        ...
        return IconButton(
          ...
          onPressed: () {
            explorePageBloc.add(
                ExplorePageLikeEvent(saveFood: RestaurantData.restaurantModel));
          },
          icon: SavedListData.saveFood.contains(RestaurantData.restaurantModel)
              ? const Icon(
                  Icons.favorite,
                  color: AppColor.globalPink,
                )
                          ...
                          child: CupertinoTextField(
                            ...
                            onChanged: (value) {
                              restaurantPageBloc.add(
                                  RestaurantPageSetReviewEvent(review: value));
                            },
                          ),
                        ),
                        children: [
                          ...
                          GestureDetector(
                              ...
                              child: RiveAnimations.reviewAnimation())
                        ],
                      ));
            },
            padding: EdgeInsets.zero,
